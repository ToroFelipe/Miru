...
android {
    ...
    signingConfigs {
        create("release") {
            // Miru release signing. Provide credentials via a local (git-ignored)
            // keystore.properties file at the repo root; never commit secrets.
