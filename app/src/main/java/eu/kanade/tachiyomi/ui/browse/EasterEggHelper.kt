...
object EasterEggHelper {
    ...
    private val rentAGirlfriendMessages = listOf(
        MR.strings.miru_easter_rent_1,
        MR.strings.miru_easter_rent_2,
        MR.strings.miru_easter_rent_3,
        MR.strings.miru_easter_rent_4,
        MR.strings.miru_easter_rent_5,
        MR.strings.miru_easter_rent_6,
        MR.strings.miru_easter_rent_7,
        MR.strings.miru_easter_rent_8,
        MR.strings.miru_easter_rent_9,
        MR.strings.miru_easter_rent_10,
    )

    private val hundredGirlfriendsMessages = listOf(
        MR.strings.miru_easter_hundred_1,
        MR.strings.miru_easter_hundred_2,
        MR.strings.miru_easter_hundred_3,
        MR.strings.miru_easter_hundred_4,
        MR.strings.miru_easter_hundred_5,
        MR.strings.miru_easter_hundred_6,
        MR.strings.miru_easter_hundred_7,
        MR.strings.miru_easter_hundred_8,
    )

    private val quintupletsMessages = listOf(
        MR.strings.miru_easter_quintuplets_1,
        MR.strings.miru_easter_quintuplets_2,
        MR.strings.miru_easter_quintuplets_3,
        MR.strings.miru_easter_quintuplets_4,
    )
        ...
        AlertDialog(
            ...
            confirmButton = {
                TextButton(onClick = onConfirm) {
                    Text(stringResource(MR.strings.miru_easter_continue_search))
                }
            },
            dismissButton = {
            ...
            title = { Text(stringResource(MR.strings.miru_easter_alert_title)) },
