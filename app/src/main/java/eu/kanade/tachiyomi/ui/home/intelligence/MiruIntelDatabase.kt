...
class MiruIntelDatabase(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {

    companion object {
        private const val DATABASE_NAME = "miru_intel.db"
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        logcat(LogPriority.INFO) { "Miru Intelligence Database created successfully." }
    }
