...
internal class ExtensionsRepoStep(
    ...
    override val title = MR.strings.miru_onboarding_extension_repo_title
    override val description = MR.strings.miru_onboarding_extension_repo_description
    ...
    override fun Content() {
        ...
        val repoAddedText = stringResource(MR.strings.miru_extension_repo_added)
        val repoInvalidText = stringResource(MR.strings.miru_extension_repo_invalid)
        val repoEmptyText = stringResource(MR.strings.miru_extension_repo_empty)
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                label = { Text(stringResource(MR.strings.miru_extension_repo_url)) },
            ...
            Button(
                ...
                if (isAdding) {
                    ...
                    Text(stringResource(MR.strings.miru_extension_repo_add))
                }
            }
        }
    }
